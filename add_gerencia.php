...
*/
    ...
    */
    if (isset($_POST['nombre']) && !empty($_POST['nombre']))
    {
        ...
        */
        mysql_query("INSERT INTO TBL_Gerencia(Nom_Gerencia) values('$nombreRG') ");
        /**
        ...
        */
        ...
        echo "<br><a href=add_gerencia.html>Agregar una Nueva Gerencia</a><br>";
    ...
    */
    else
    {
        ...
        */
        ...
        echo "<br><a href=add_gerencia.html>Volver al formulario</a><br>";
    }
?>