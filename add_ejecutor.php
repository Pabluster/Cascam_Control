...
*/
    ...
    */
    ...
    isset($_POST['rut']) && !empty($_POST['rut']))
    {
        ...
        */
        mysql_query("INSERT INTO TBL_Ejecutor(Nom_Ejecutor,RUT,Cargo) values('$nombreRG','$rutRG','$cargoRG') ");
        /**
        ...
        */
        ...
        echo "<a href=add_ejecutor.html>Volver al formulario</a>";
    ...
    */
    else
    {
        ...
        */
        ...
        echo "<br><a href=add_ejecutor.html>Volver al formulario</a><br>";
    }
?>